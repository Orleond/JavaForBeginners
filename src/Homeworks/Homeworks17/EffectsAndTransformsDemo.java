...
/**
 * Модифицируйте программу EffectsAndTransformsDemo
 * таким образом, чтобы размытие применялось также
 * к кнопке Повернуть. Задайте для ширины и высоты
 * области размытия значение 5, а для счетчика
 * итерация = значение 2
 */
